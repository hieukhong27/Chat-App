...
const { searchUsers, sendFriendRequest, acceptFriendRequest, getFriends, getFriendRequests,rejectFriendRequest } = require('../controllers/userController');
...
router.post('/friend-reject', authenticate, rejectFriendRequest);
